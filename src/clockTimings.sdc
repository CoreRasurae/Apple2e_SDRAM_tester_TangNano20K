...
create_clock -name clk112M -period 8.94 -waveform {0 4.47} [get_pins {myrPLL/rpll_inst/CLKOUTD}]
create_clock -name clk8M -period 125.156 -waveform {0 62.578} [get_pins {myrPLL/rpll_inst/CLKOUT}]
